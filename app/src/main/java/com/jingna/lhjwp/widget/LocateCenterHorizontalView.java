package com.jingna.lhjwp.widget;
...
public class LocateCenterHorizontalView extends RecyclerView {
    ...
    public LocateCenterHorizontalView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LocateCenterHorizontalView(Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    /**
     * 设置初始化时选中的位置,该方法必须在{@link LocateCenterHorizontalView#setAdapter(android.support.v7.widget.RecyclerView.Adapter) }之前调用
     *
    ...
    /**
     * 设置每次显示多少个item,该方法必须在{@link LocateCenterHorizontalView#setAdapter(android.support.v7.widget.RecyclerView.Adapter) }之前调用
     *
