...
public class ProPicAddShowAdapter extends RecyclerView.Adapter<ProPicAddShowAdapter.ViewHolder> {
    ...
    public ProPicAddShowAdapter(List<ProPicInfo> data) {
        this.data = data;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_pro_add_show_pic, parent, false);
